...
class YahooFinanceData(YahooFinanceCSVData):
    ...
    def start_v7(self):
        ...
        #sess.headers['User-Agent'] = 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.95 Safari/537.36' #'backtrader' 
        sess.headers["Connection" ] = "keep-alive"
        sess.headers["Expires" ] = str(-1)
        sess.headers["Upgrade-Insecure-Requests"] =  str(1)
            # Google Chrome:
        sess.headers["User-Agent"] = "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 " + \
